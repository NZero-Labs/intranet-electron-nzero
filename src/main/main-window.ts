import { app, BrowserWindow, clipboard, dialog, ipcMain, net, protocol, Session, session } from 'electron';
import path from 'path';
import { unlink } from 'fs';
import { is } from '@electron-toolkit/utils';
import { closeTab, getSelectedTabId, restoreTabs, saveTabs, showContent } from '~/main/tabs';
...
export async function initializeMainWindow() {
  ...
  baseWindow = new BrowserWindow({
    ...
    ...(process.platform === 'darwin' ? { titleBarStyle: 'hiddenInset' } : { titleBarStyle: "customButtonsOnHover"}),
  });
