...
const createWindow = (): void => {
  ...
  function handleDownload(payload: DownloadPayloadProps) {
    ...
    const defaultFileName =
      ...
      "download";
    console.log("🚀 ~ handleDownload ~ defaultPath:", defaultPath)
    console.log("🚀 ~ handleDownload ~ defaultFileName:", defaultFileName)
    ...
    if (customURL) {
      filePath = customURL;
      console.log("🚀 ~ handleDownload ~ filePath, url:", filePath, payload.url)
